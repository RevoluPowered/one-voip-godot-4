...
if __name__ == "__main__":
    ...
    class AntPatternToRETest(unittest.TestCase):
        ...
        def test_matching(self):
            test_cases = [
                ("path", ["path"], ["somepath", "pathsuffix", "/path", "/path"]),
                ("*.py", ["source.py", "source.ext.py", ".py"], ["path/source.py", "/.py", "dir.py/z", "z.pyc", "z.c"]),
                (
                    "**/path",
                ...
                ("a/b", ["a/b"], ["somea/b", "a/bsuffix", "a/b/c"]),
                (
                    "**/*.py",
                    ["script.py", "src/script.py", "a/b/script.py", "/a/b/script.py"],
                    ["script.pyc", "script.pyo", "a.py/b"],
                ),
                ("src/**/*.py", ["src/a.py", "src/dir/a.py"], ["a/src/a.py", "/src/a.py"]),
            ]
