...
def build_doc(options, make_release=False):
    ...
    if options.make_tarball:
        ...
        tarball_sources = [output_dir, "README.md", "LICENSE", "NEWS.txt", "version"]
...
def main():
    ...
    parser.add_option(
        ...
        dest="doxygen_path",
        action="store",
        default=find_program("doxygen"),
        help="""Path to Doxygen tool. [Default: %default]""",
    )
    parser.add_option(
        "--in",
        dest="doxyfile_input_path",
        action="store",
        default="doc/doxyfile.in",
    ...
    parser.add_option(
        "-s", "--silent", dest="silent", action="store_true", default=False, help="""Hides doxygen output"""
    )
